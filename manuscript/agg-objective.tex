...
\begin{itemize}
\item \textbf{Computability}. The result should be computed using only the disclosure, plus resources available to the reader.  The computation should follow the consensus understanding of process LCA computation.
...
\item \textbf{Autonomy}.  The disclosure should exclude information that is owned by a third party.
