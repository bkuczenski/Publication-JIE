...
The author may relax the disclosure constraints by reporting the locations of some or all non-zero entries in $A_{d,priv}$ and $B_{f,priv}$ but not disclosing their values. This would enable a reader to understand \emph{that} a certain background process or emission was included in the model, but not to know \emph{how much} was included.
