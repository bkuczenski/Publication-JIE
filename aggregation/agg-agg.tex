...
%A {\red fragment} subset of the columns of $A_f$ may also be published  of the PSM can also be published as a complete foreground. %
Any co-production treatment, such as an allocation or system expansion, can only be fully expressed as a foreground fragment, because it intrinsically involves a collection of linked unit processes.
