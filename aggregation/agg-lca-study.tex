...
The activity levels of the foreground nodes are represented by $\tilde{\mathbf{x}}$, which is the result of $\tilde{\mathbf{y}}$ selecting the first column of $(I-A_f)^{-1}$.
