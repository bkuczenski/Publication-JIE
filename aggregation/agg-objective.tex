...
In the context of this paper, an ``LCA Study'' should be understood as any collection of inventory data under consideration, from a single-operation unit process to a full ISO-style product LCA.
